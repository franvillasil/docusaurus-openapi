...
function isDraftForEnvironment({ env, frontMatter }) {
  var _a;
  return (_a = env === "production" && frontMatter.draft) !== null &&
    _a !== void 0
    ? _a
    : false;
}
async function doProcessDocMetadata({
  ...
  const {
    ...
    contentTitle,
    excerpt,
  } = (0, utils_1.parseMarkdownString)(content);
  ...
  const baseID =
    (_a = frontMatter.id) !== null && _a !== void 0 ? _a : unprefixedFileName;
  if (baseID.includes("/")) {
  ...
  const sidebarPosition =
    (_b = frontMatter.sidebar_position) !== null && _b !== void 0
      ? _b
      : numberPrefix;
  ...
  const title =
    (_d =
      (_c = frontMatter.title) !== null && _c !== void 0
        ? _c
        : contentTitle) !== null && _d !== void 0
      ? _d
      : baseID;
  const description =
    (_f =
      (_e = frontMatter.description) !== null && _e !== void 0
        ? _e
        : excerpt) !== null && _f !== void 0
      ? _f
      : "";
