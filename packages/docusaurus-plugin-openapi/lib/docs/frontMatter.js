...
const DocFrontMatterSchema = utils_validation_1.JoiFrontMatter.object({
  ...
  keywords: utils_validation_1.JoiFrontMatter.array().items(
    utils_validation_1.JoiFrontMatter.string().required()
  ),
...
function validateDocFrontMatter(frontMatter) {
  return (0, utils_validation_1.validateFrontMatter)(
    frontMatter,
