...
function getSlug({
  ...
  function getDirNameSlug() {
    ...
    const resolveDirname =
      sourceDirName === "."
        ? "/"
        : (0, utils_1.addLeadingSlash)(
            (0, utils_1.addTrailingSlash)(dirNameStripped)
          );
    return resolveDirname;
  }
  function computeSlug() {
    if (
      frontMatterSlug === null || frontMatterSlug === void 0
        ? void 0
        : frontMatterSlug.startsWith("/")
    ) {
    ...
    if (
      !frontMatterSlug &&
      (0, docs_1.isCategoryIndex)(
        (0, docs_1.toCategoryIndexMatcherParam)({ source, sourceDirName })
      )
    ) {
      return dirNameSlug;
    }
