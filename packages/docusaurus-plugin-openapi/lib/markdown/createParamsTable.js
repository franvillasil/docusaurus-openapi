...
function createParamsTable({ parameters, type }) {
  ...
  const params = parameters.filter(
    (param) => (param === null || param === void 0 ? void 0 : param.in) === type
  );
  if (params.length === 0) {
    return undefined;
  }
        ...
        children: params.map((param) => {
          ...
          return (0, utils_1.create)("tr", {
            children: (0, utils_1.create)("td", {
              children: [
                (0, utils_1.create)("code", {
                  children: (0, lodash_1.escape)(param.name),
                }),
                (0, utils_1.guard)(param.schema, (schema) =>
                ...
                (0, utils_1.guard)(
                  (0, schema_1.getQualifierMessage)(param.schema),
                  (message) =>
                ...
                (0, utils_1.guard)(
                  (_a = param.schema) === null || _a === void 0
                    ? void 0
                    : _a.description,
                  (description) =>
                    (0, utils_1.create)("div", {
                ...
                (0, utils_1.guard)(param.description, (description) =>
                  (0, utils_1.create)("div", {
                    style: { marginTop: "var(--ifm-table-cell-padding)" },
                    children: (0, createDescription_1.createDescription)(
                      description
                ...
                (0, utils_1.guard)(param.example, (example) =>
                  (0, utils_1.create)("div", {
                    style: { marginTop: "var(--ifm-table-cell-padding)" },
                    children: (0, lodash_1.escape)(`Example: ${example}`),
                  })
                ),
                (0, utils_1.guard)(param.examples, (examples) =>
                  (0, utils_1.create)("div", {
                    style: { marginTop: "var(--ifm-table-cell-padding)" },
                    children: Object.entries(examples).map(([k, v]) =>
                      (0, utils_1.create)("div", {
                        children: (0, lodash_1.escape)(
                          `Example (${k}): ${v.value}`
                        ),
                      })
                    ),
