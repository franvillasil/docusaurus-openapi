...
describe("sidebars", () => {
  ...
  describe("Single Spec - YAML", () => {
    it("base case - single spec with untagged routes should render flat with a default category", async () => {
      ...
      expect(info === null || info === void 0 ? void 0 : info.type).toBe(
        "link"
      );
      expect(info === null || info === void 0 ? void 0 : info.label).toBe(
        "Introduction"
      );
      expect(info === null || info === void 0 ? void 0 : info.href).toBe(
        "/yaml/introduction"
      );
      ...
      const api =
        category === null || category === void 0
          ? void 0
          : category.items.find(isLink);
      expect(api === null || api === void 0 ? void 0 : api.label).toBe(
        "Hello World"
      );
      expect(api === null || api === void 0 ? void 0 : api.docId).toBe(
        "hello-world"
      );
    });
    it("single spec tags case - should render root level categories per tag", async () => {
      ...
      expect(
        api === null || api === void 0 ? void 0 : api.items
      ).toBeInstanceOf(Array);
      expect(api === null || api === void 0 ? void 0 : api.items).toHaveLength(
        1
      );
      const [helloWorld] =
        (_a = api === null || api === void 0 ? void 0 : api.items) !== null &&
        _a !== void 0
          ? _a
          : [];
  ...
  describe("Multi Spec", () => {
    ...
    it("multi spec, multi tag", async () => {
      ...
      expect(
        (_a = tails.items) === null || _a === void 0 ? void 0 : _a[0].type
      ).toBe("link");
      expect(
        (_b = whiskers.items) === null || _b === void 0 ? void 0 : _b[0].type
      ).toBe("link");
      expect(
        (_c = tails.items) === null || _c === void 0 ? void 0 : _c[0].label
      ).toBe("List Tails");
      expect(
        (_d = whiskers.items) === null || _d === void 0 ? void 0 : _d[0].label
      ).toBe("List whiskers");
      expect(dogs.type).toBe("category");
