...
async function generateSidebar(items, options) {
  ...
  for (const items of Object.values(sourceGroups)) {
    ...
    for (const crumb of breadcrumbs) {
      ...
      if (crumb === Terminator) {
        if (isMdxItem(items[0])) {
          ...
          ["_spec_.json", "_spec_.yml", "_spec_.yaml"].includes(
            path_1.default.basename(items[0].source)
          )
        ) {
          ...
          const title =
            (_b =
              (_a = items.filter(isApiItem)[0]) === null || _a === void 0
                ? void 0
                : _a.api.info) === null || _b === void 0
              ? void 0
              : _b.title;
      ...
      const categoryPath = path_1.default.join(
        options.contentPath,
        ...currentPath
      );
      const meta = await readCategoryMetadataFile(categoryPath);
      const label =
        (_c = meta === null || meta === void 0 ? void 0 : meta.label) !==
          null && _c !== void 0
          ? _c
          : crumb;
      ...
      const newCategory = {
        ...
        customProps:
          meta === null || meta === void 0 ? void 0 : meta.customProps,
        position:
          (_d = meta === null || meta === void 0 ? void 0 : meta.position) !==
            null && _d !== void 0
            ? _d
        ...
        collapsible:
          (_e =
            meta === null || meta === void 0 ? void 0 : meta.collapsible) !==
            null && _e !== void 0
            ? _e
            : options.sidebarCollapsible,
        collapsed:
          (_f = meta === null || meta === void 0 ? void 0 : meta.collapsed) !==
            null && _f !== void 0
            ? _f
...
function groupByTags(items, options) {
  const intros = items
    ...
    .map((item) => {
      ...
      const fileName = path_1.default.basename(
        item.source,
        path_1.default.extname(item.source)
      );
      ...
      return {
        ...
        position: isMdxItem(item)
          ? (_b =
              (_a = item.frontMatter) === null || _a === void 0
                ? void 0
                : _a.sidebar_position) !== null && _b !== void 0
            ? _b
            : BottomSidebarPosition
          : BottomSidebarPosition,
      };
  ...
  const tags = (0, lodash_1.uniq)(
    apiItems.flatMap((item) => item.api.tags).filter((item) => !!item)
  );
    ...
    .map((tag) => {
      return {
        ...
        items: apiItems
          .filter((item) => {
            var _a;
            return !!((_a = item.api.tags) === null || _a === void 0
              ? void 0
              : _a.includes(tag));
          })
          .map(createLink),
...
async function readCategoryMetadataFile(categoryDirPath) {
  async function tryReadFile(filePath) {
    const contentString = await fs_extra_1.default.readFile(filePath, {
      encoding: "utf8",
    });
  ...
  for (const ext of [".json", ".yml", ".yaml"]) {
    ...
    const filePath = (0, utils_1.posixPath)(
      path_1.default.join(
        categoryDirPath,
        `${CategoryMetadataFilenameBase}${ext}`
      )
    );
