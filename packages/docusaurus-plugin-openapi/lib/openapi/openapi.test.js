...
describe("openapi", () => {
  describe("readOpenapiFiles", () => {
    it("readOpenapiFiles", async () => {
      const results = await (0, _1.readOpenapiFiles)(
        path_1.default.join(__dirname, "__fixtures__/examples"),
        {}
      );
      ...
      expect(
        yaml === null || yaml === void 0 ? void 0 : yaml.sourceDirName
      ).toBe(".");
      const froyo = results.find((x) => x.source.endsWith("froyo.yaml"));
      expect(froyo).toBeTruthy();
      expect(
        froyo === null || froyo === void 0 ? void 0 : froyo.sourceDirName
      ).toBe("yogurtstore");
      const nested = results.find((x) => x.source.endsWith("nested.yaml"));
      expect(nested).toBeTruthy();
      expect(
        nested === null || nested === void 0 ? void 0 : nested.sourceDirName
      ).toBe("yogurtstore/nested");
    });
  });
});
