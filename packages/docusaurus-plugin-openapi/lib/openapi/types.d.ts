...
export declare type ResponsesObjectWithRef = Map<
...
export declare type HeaderObjectWithRef = Omit<
...
export declare type SchemaObject = Omit<
  JSONSchema,
  | "type"
  | "allOf"
  | "oneOf"
...
export declare type SchemaObjectWithRef = Omit<
  JSONSchema,
  | "type"
  | "allOf"
  | "oneOf"
