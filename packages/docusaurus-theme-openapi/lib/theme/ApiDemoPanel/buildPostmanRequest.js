...
function setBody(clonedPostman, body) {
  ...
  if (
    body.type === "raw" &&
    ((_body$content = body.content) === null || _body$content === void 0
      ? void 0
      : _body$content.type) === "file"
  ) {
    // treat it like file.
  ...
  switch (clonedPostman.body.mode) {
    case "raw": {
      ...
      if (
        body.type !== "raw" ||
        ((_body$content2 = body.content) === null || _body$content2 === void 0
          ? void 0
          : _body$content2.type) === "file"
      ) {
        clonedPostman.body = undefined;
        return;
      }

      clonedPostman.body.raw =
        (_body$content$value =
          (_body$content3 = body.content) === null || _body$content3 === void 0
            ? void 0
            : _body$content3.value) !== null && _body$content$value !== void 0
          ? _body$content$value
          : "";
      return;
    }
    ...
    case "formdata": {
      ...
      (_clonedPostman$body$f = clonedPostman.body.formdata) === null ||
      _clonedPostman$body$f === void 0
        ? void 0
        : _clonedPostman$body$f.clear();
      ...
      if (body.type !== "form") {
        ...
        clonedPostman.body.raw = `${
          (_body$content4 = body.content) === null || _body$content4 === void 0
            ? void 0
            : _body$content4.value
        }`;
        return;
      }
      ...
      (_clonedPostman$body$f2 = clonedPostman.body.formdata) === null ||
      _clonedPostman$body$f2 === void 0
        ? void 0
        : _clonedPostman$body$f2.assimilate(params, false);
      return;
    }
    ...
    case "urlencoded": {
      ...
      (_clonedPostman$body$u = clonedPostman.body.urlencoded) === null ||
      _clonedPostman$body$u === void 0
        ? void 0
        : _clonedPostman$body$u.clear();
      ...
      if (body.type !== "form") {
        ...
        clonedPostman.body.mode = "raw";
        clonedPostman.body.raw = `${
          (_body$content5 = body.content) === null || _body$content5 === void 0
            ? void 0
            : _body$content5.value
        }`;
        return;
      }
      ...
      const params = Object.entries(body.content)
        ...
        .filter((item) => item !== undefined);
      (_clonedPostman$body$u2 = clonedPostman.body.urlencoded) === null ||
      _clonedPostman$body$u2 === void 0
        ? void 0
        : _clonedPostman$body$u2.assimilate(params, false);
      return;
    }
