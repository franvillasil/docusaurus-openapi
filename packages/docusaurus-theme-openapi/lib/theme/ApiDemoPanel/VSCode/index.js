...
function VSCode({ value, language, onChange }) {
  ...
  const { colorMode } = (0, _themeCommon.useColorMode)();
  ...
  return (
    <div
      className={
        focused
          ? _stylesModule.default.monacoFocus
          : _stylesModule.default.monaco
      }
    >
      <_react2.default
        value={value}
        ...
        onMount={(editor) => {
          ...
          const updateEditorHeight = () => {
            ...
            const lineHeight = 22;
            const lineCount =
              ((_editor$getModel = editor.getModel()) === null ||
              _editor$getModel === void 0
                ? void 0
                : _editor$getModel.getLineCount()) || 1;
            const height =
