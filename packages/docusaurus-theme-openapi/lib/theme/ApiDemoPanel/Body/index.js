...
function Body({ requestBodyMetadata, jsonRequestBodyExample }) {
  ...
  const schema =
    requestBodyMetadata === null || requestBodyMetadata === void 0
      ? void 0
      : (_requestBodyMetadata$ = requestBodyMetadata.content) === null ||
        _requestBodyMetadata$ === void 0
      ? void 0
      : (_requestBodyMetadata$2 = _requestBodyMetadata$[contentType]) ===
          null || _requestBodyMetadata$2 === void 0
      ? void 0
      : _requestBodyMetadata$2.schema;

  if (
    (schema === null || schema === void 0 ? void 0 : schema.format) === "binary"
  ) {
    return (
      <_FormItem.default label="Body">
        <_FormFileUpload.default
  ...
  if (
    ...
    return (
      <_FormItem.default label="Body">
        ...
        >
          {Object.entries(
            (_schema$properties = schema.properties) !== null &&
              _schema$properties !== void 0
              ? _schema$properties
              : {}
          ).map(([key, val]) => {
            if (val.format === "binary") {
              return (
                <_FormItem.default key={key} label={key}>
                  <_FormFileUpload.default
