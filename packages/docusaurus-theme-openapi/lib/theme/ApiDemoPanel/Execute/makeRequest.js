...
async function makeRequest(request, proxy, _body) {
  ...
  const body =
    (_request$body = request.body) === null || _request$body === void 0
      ? void 0
      : _request$body.toJSON();
  ...
  if (body !== undefined && Object.keys(body).length > 0) {
    switch (body.mode) {
      ...
      case "raw": {
        ...
        myBody = (
          (_body$raw = body.raw) !== null && _body$raw !== void 0
            ? _body$raw
            : ""
        ).toString();
        break;
      ...
      case "file": {
        ...
        if (
          _body.type === "raw" &&
          ((_body$content = _body.content) === null || _body$content === void 0
            ? void 0
