...
function ContentType() {
  const value = (0, _hooks.useTypedSelector)(
    (state) => state.contentType.value
  );
  const options = (0, _hooks.useTypedSelector)(
  ...
  return (
    <_FormItem.default label="Content-Type">
      <_FormSelect.default
        value={value}
        options={options}
        onChange={(e) => dispatch((0, _slice.setContentType)(e.target.value))}
      />
    </_FormItem.default>
  );
}
