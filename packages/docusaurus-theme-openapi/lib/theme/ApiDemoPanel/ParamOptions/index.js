...
function ParamOption({ param }) {
  ...
  if (
    ((_param$schema = param.schema) === null || _param$schema === void 0
      ? void 0
      : _param$schema.type) === "array" &&
    (_param$schema$items = param.schema.items) !== null &&
    _param$schema$items !== void 0 &&
    _param$schema$items.enum
  ) {
    return <ParamMultiSelectFormItem param={param} />;
  }

  if (
    ((_param$schema2 = param.schema) === null || _param$schema2 === void 0
      ? void 0
      : _param$schema2.type) === "array"
  ) {
    return <ParamArrayFormItem param={param} />;
  }

  if (
    (_param$schema3 = param.schema) !== null &&
    _param$schema3 !== void 0 &&
    _param$schema3.enum
  ) {
  ...
  if (
    ((_param$schema4 = param.schema) === null || _param$schema4 === void 0
      ? void 0
      : _param$schema4.type) === "boolean"
  ) {
...
function ParamOptionWrapper({ param }) {
  return (
    <_FormItem.default label={param.name} type={param.in}>
...
function ParamOptions() {
  ...
  const queryParams = (0, _hooks.useTypedSelector)(
    (state) => state.params.query
  );
  const cookieParams = (0, _hooks.useTypedSelector)(
    (state) => state.params.cookie
  );
  const headerParams = (0, _hooks.useTypedSelector)(
  ...
  return (
    <>
      ...
      {optionalParams.length > 0 && (
        <>
          <button
            className={_stylesModule.default.showMoreButton}
          ...
          >
            ...
            >
              <span
                className={
                  showOptional
                    ? _stylesModule.default.plusExpanded
                    : _stylesModule.default.plus
                }
              >
                <div>
                  <svg
          ...
          <div
            className={
              showOptional
                ? _stylesModule.default.showOptions
                : _stylesModule.default.hideOptions
            }
          >
...
function ArrayItem({ param, onChange }) {
  ...
  if (
    ((_param$schema5 = param.schema) === null || _param$schema5 === void 0
      ? void 0
      : (_param$schema5$items = _param$schema5.items) === null ||
        _param$schema5$items === void 0
      ? void 0
      : _param$schema5$items.type) === "boolean"
  ) {
    return (
      <_FormSelect.default
        options={["---", "true", "false"]}
    ...
    <>
      {items.map((item) => (
        ...
        >
          ...
          <button
            className={_stylesModule.default.buttonDelete}
      ...
      <button
        className={_stylesModule.default.buttonThin}
...
function ParamSelectFormItem({ param }) {
  ...
  const options =
    (_param$schema$enum =
      (_param$schema6 = param.schema) === null || _param$schema6 === void 0
        ? void 0
        : _param$schema6.enum) !== null && _param$schema$enum !== void 0
      ? _param$schema$enum
      : [];
  return (
    <_FormSelect.default
...
function ParamMultiSelectFormItem({ param }) {
  ...
  const dispatch = (0, _hooks.useTypedDispatch)();
  const options =
    (_param$schema$items$e =
      (_param$schema7 = param.schema) === null || _param$schema7 === void 0
        ? void 0
        : (_param$schema7$items = _param$schema7.items) === null ||
          _param$schema7$items === void 0
        ? void 0
        : _param$schema7$items.enum) !== null &&
    _param$schema$items$e !== void 0
      ? _param$schema$items$e
      : [];
  return (
    <_FormMultiSelect.default
      options={options}
      onChange={(e) => {
...
function ParamTextFormItem({ param }) {
  ...
  return (
    <_FormTextInput.default
      placeholder={param.description || param.name}
      onChange={(e) =>
        dispatch((0, _slice.setParam)({ ...param, value: e.target.value }))
      }
    />
  );
}
