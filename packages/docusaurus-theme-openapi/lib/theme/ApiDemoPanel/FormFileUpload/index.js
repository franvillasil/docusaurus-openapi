...
var _reactMagicDropzone = _interopRequireDefault(
  require("react-magic-dropzone")
);
  ...
  return (
    <_FloatingButton.default>
      <_reactMagicDropzone.default
        className={
          hover
            ? _stylesModule.default.dropzoneHover
            : _stylesModule.default.dropzone
        }
        onDrop={handleDrop}
      ...
      >
        {file ? (
          ...
          <div className={_stylesModule.default.dropzoneContent}>
            {placeholder}
          </div>
        )}
      </_reactMagicDropzone.default>
