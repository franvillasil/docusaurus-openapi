...
function ApiDemoPanel({ item }) {
  ...
  const acceptArray = Array.from(
    new Set(
      Object.values(
        (_item$responses = item.responses) !== null &&
          _item$responses !== void 0
          ? _item$responses
          : {}
      )
        .map((response) => {
          ...
          return Object.keys(
            (_response$content = response.content) !== null &&
              _response$content !== void 0
              ? _response$content
              : {}
          );
        })
  ...
  const content =
    (_item$requestBody$con =
      (_item$requestBody = item.requestBody) === null ||
      _item$requestBody === void 0
        ? void 0
        : _item$requestBody.content) !== null &&
    _item$requestBody$con !== void 0
      ? _item$requestBody$con
      : {};
  const contentTypeArray = Object.keys(content);
  const servers =
    (_item$servers = item.servers) !== null && _item$servers !== void 0
      ? _item$servers
      : [];
  const params = {
    path: [],
  ...
  (_item$parameters = item.parameters) === null || _item$parameters === void 0
    ? void 0
  ...
  _persistanceMiddleware.createPersistanceMiddleware)(options);
    ...
    <_reactRedux.Provider store={store2}>
      ...
      >
        ...
        <_Curl.default
          postman={postman}
          codeSamples={
            (_xCodeSamples = item["x-code-samples"]) !== null &&
            _xCodeSamples !== void 0
              ? _xCodeSamples
              : []
          }
        />
