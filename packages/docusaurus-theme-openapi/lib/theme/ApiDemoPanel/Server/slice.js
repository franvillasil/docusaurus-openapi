 ...
 * ========================================================================== */
function createServer({ servers, options: opts }) {
  ...
  let options = servers.map((s) => {
    ...
    try {
      ...
      persisted = JSON.parse(
        (_storage$getItem = storage.getItem(
          `docusaurus.openapi.server/${s.url}`
        )) !== null && _storage$getItem !== void 0
          ? _storage$getItem
          : ""
      );
    } catch {}
    ...
    srv.variables =
      (_srv$variables = srv.variables) !== null && _srv$variables !== void 0
        ? _srv$variables
        : {};
...
const slice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    ...
    setServerVariable: (state, action) => {
      ...
      if (
        (_state$value = state.value) !== null &&
        _state$value !== void 0 &&
        _state$value.variables
      ) {
...
exports.slice = slice;
const { setServer, setServerVariable } = slice.actions;
