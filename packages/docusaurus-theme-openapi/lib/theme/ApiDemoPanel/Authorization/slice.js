...
function createAuth({ security, securitySchemes, options: opts }) {
  ...
  const storage = (0, _storageUtils.createStorage)(
    opts === null || opts === void 0 ? void 0 : opts.authPersistance
  );
  let data = {};
  let options = {};

  for (const option of security !== null && security !== void 0
    ? security
    : []) {
    ...
    for (const [schemeID, scopes] of Object.entries(option)) {
      const scheme =
        securitySchemes === null || securitySchemes === void 0
          ? void 0
        ...
        for (const key of dataKeys) {
          ...
          try {
            ...
            persisted = JSON.parse(
              (_storage$getItem = storage.getItem(schemeID)) !== null &&
                _storage$getItem !== void 0
                ? _storage$getItem
                : ""
            )[key];
          } catch {}
  ...
  try {
    ...
    persisted =
      (_storage$getItem2 = storage.getItem(
        (0, _storageUtils.hashArray)(Object.keys(options))
      )) !== null && _storage$getItem2 !== void 0
        ? _storage$getItem2
        : undefined;
  } catch {}
  ...
  return {
    ...
    options,
    selected:
      (_persisted = persisted) !== null && _persisted !== void 0
        ? _persisted
...
exports.slice = slice;
const { setAuthData, setSelectedAuth } = slice.actions;
