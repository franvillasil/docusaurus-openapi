...
var _useDocusaurusContext = _interopRequireDefault(
  require("@docusaurus/useDocusaurusContext")
);

var _clsx = _interopRequireDefault(require("clsx"));

var _postmanCodeGenerators = _interopRequireDefault(
...
var _buildPostmanRequest = _interopRequireDefault(
  require("./../buildPostmanRequest")
);
...
function Curl({ postman, codeSamples }) {
  ...
  const { siteConfig } = (0, _useDocusaurusContext.default)();
  const [copyText, setCopyText] = (0, _react.useState)("Copy");
  const contentType = (0, _hooks.useTypedSelector)(
  ...
  const langs = [
    ...((_ref =
      siteConfig === null || siteConfig === void 0
        ? void 0
        : (_siteConfig$themeConf = siteConfig.themeConfig) === null ||
          _siteConfig$themeConf === void 0
        ? void 0
        : _siteConfig$themeConf.languageTabs) !== null && _ref !== void 0
      ? _ref
      : languageSet),
    ...codeSamples,
  ];
  ...
  (0, _react.useEffect)(() => {
    if (language && !!language.options) {
      ...
      _postmanCodeGenerators.default.convert(
        language.language,
        language.variant,
        postmanRequest,
        language.options,
    ...
    <>
      <div
        className={(0, _clsx.default)(
          _stylesModule.default.buttonGroup,
          "api-code-tab-group"
        )}
      >
        {langs.map((lang) => {
          return (
            <button
              ...
              className={(0, _clsx.default)(
                language === lang ? _stylesModule.default.selected : undefined,
