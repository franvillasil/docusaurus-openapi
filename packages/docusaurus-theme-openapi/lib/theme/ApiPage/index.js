...
var _BackToTopButton = _interopRequireDefault(
  require("@theme/BackToTopButton")
);
...
function ApiPageContent({ currentApiRoute, apiMetadata, children }) {
  ...
  const [hiddenSidebarContainer, setHiddenSidebarContainer] = (0,
  ...
  return (
    <_Layout.default wrapperClassName="api-wrapper">
      <div className={_stylesModule.default.apiPage}>
        ...
        {sidebar && (
          <aside
            className={(0, _clsx.default)(
              _stylesModule.default.apiSidebarContainer,
              {
                [_stylesModule.default.apiSidebarContainerHidden]:
          ...
          >
            ...
            {hiddenSidebar && (
              <div
                className={_stylesModule.default.collapsedApiSidebar}
                title={(0, _Translate.translate)({
              ...
              >
                <_Arrow.default
                  className={_stylesModule.default.expandSidebarButtonIcon}
                />
              </div>
            )}
          </aside>
        ...
        <main
          className={(0, _clsx.default)(
            _stylesModule.default.apiMainContainer,
            {
              [_stylesModule.default.apiMainContainerEnhanced]:
        ...
        >
          <div
            className={(0, _clsx.default)(
              ...
              {
                [_stylesModule.default.apiItemWrapperEnhanced]:
                  hiddenSidebarContainer,
              }
            )}
          >
...
function ApiPage(props) {
  ...
  let currentApiRoute = apiRoutes.find((apiRoute) =>
    (0, _router.matchPath)(location.pathname, apiRoute)
  );
  ...
  if (!paths.find((path) => (0, _router.matchPath)(location.pathname, path))) {
    currentApiRoute = { ...currentApiRoute, path: paths[0] };
  }
